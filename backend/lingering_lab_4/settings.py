"""
Django settings for lingering_lab_4 project.
...
ROOT_URLCONF = 'lingering_lab_4.urls'
...
WSGI_APPLICATION = 'lingering_lab_4.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "Lingering Lab Support <support@lingering-lab-4.botics.io>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "lingering_lab_4 API",
    "DESCRIPTION": "API documentation for lingering_lab_4 App",
    "VERSION": "v1",
}
